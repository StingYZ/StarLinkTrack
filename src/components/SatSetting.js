   ...
   render() {
       ...
       return (
           <Form {...formItemLayout} className="sat-setting" onSubmit={this.showSatellite}>
               ...
               <Form.Item label="Ridius range(degrees)">
                   {
                       getFieldDecorator("ridiusRange", {
                           rules: [
                               {
                                   required: true,
                                   message: "Please input your Ridius range",
                               }
                           ],
                       })(<InputNumber placeholder="Please input Ridius range"
                                       min={0} max={90}
                                       style={{width: "100%"}}
                       /> )
                   }
